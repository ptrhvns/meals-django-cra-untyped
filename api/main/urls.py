...
urlpatterns = [
    ...
    urls.path(
        "create_recipe_tag/<int:recipe_id>/",
        views.create_recipe_tag,
        name="create_recipe_tag",
    ),
    urls.path(
    ...
    urls.path(
        "delete_recipe_tag/<int:tag_id>",
        views.delete_recipe_tag,
    ...
    urls.path(
        "update_recipe_tag/<int:tag_id>",
        views.update_recipe_tag,
        name="update_recipe_tag",
    ),
    urls.path(
